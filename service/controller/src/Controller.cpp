...
OCStackResult Controller::start()
{
   ...
   // m_discoveryManagerBLE.discoverResource(OC_RSRVD_WELL_KNOWN_URI, types, m_discoveryCallbackBLE, "", CT_ADAPTER_GATT_BTLE);
...
ResourceObject::ResourceObjectStateCallback Controller::getControllerResourceStateObjCallback()
{
 ...
 void Controller::foundResourceCallbackBLE(OCResource::Ptr resource)
 {
     ...
     std::cout << "===================================================" << std::endl;
     m_discoveryCallback(RCSRemoteResourceObject::fromOCResource(resource));
 }
